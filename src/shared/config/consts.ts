export const REQUESTS_TIMEOUT = 10000; // ms
...
export const LINK_VK = "https://vk.com/0guitars";
export const LINK_YOUTUBE = "https://www.youtube.com/@0guitars";
export const LINK_TELEGRAM = "https://t.me/konograi";
